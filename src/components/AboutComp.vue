<template>
    <div class="bg">
        ...
        <div class="container about">
            ...
            <h1 class="p-5" data-aos="zoom-in">Hobbies & Interests</h1>
            ...
            <router-link to="/resume" exact v-scroll-to="{ el:'#resume' }" id="res" class="btn btn-light m-3 p-3 ">View Resume</router-link>
        </div>
    </div>
</template>
